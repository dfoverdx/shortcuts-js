...
interface WFWorkflowActionParameters {
  ...
  WFConditionalActionString?: string | Variable;
  ...
  WFDictionary?: Variable;
  WFDictionaryKey?: string | WFSerialization;
  WFDictionaryValue?: string | number | WFSerialization;
  ...
  WFInput?: string | number | Variable;
  ...
  WFNotificationActionBody?: string | WFSerialization;
  WFNotificationActionSound?: boolean;
  WFNotificationActionTitle?: string | WFSerialization;
  WFNumberActionNumber?: number;
  WFNumberValue?: number | Variable;
  ...
  WFScientificMathOperand?: number | Variable;
